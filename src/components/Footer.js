          ...
          <div className="container">
            <div className="row">
              <div className="col-lg-5 col-md-12">
                ...
                <p className="my-3">
                  <b>Address </b>(Abdullah Campus): Ali-alam garden, lahore
                  medical housing scheme, Tulspura,Lahore{" "}
                </p>
                <p className="my-3">
                  <b>Address</b> (Abdulrehman Campus): Al-qalam school, Jhggian
                  village, jallo,Lahore{" "}
                </p>
                <p>
                  <b>Contact:</b>
                  <span className="mx-2">
